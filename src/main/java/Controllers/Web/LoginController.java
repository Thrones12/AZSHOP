...
@WebServlet(urlPatterns = { "/user/web/login", "/user/web/logout", "/user/web/register", "/user/web/forgotpass",
		 					"/user/web/waiting",  "/user/web/VerifyCode"})
public class LoginController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(url.contains("register")) {
			...
			req.getRequestDispatcher("/Views/web/forgotpass.jsp").forward(req, resp);
	...
	private void postRegister(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(userService.checkExistEmail(email)) {
			...
			if(test) {
				...
				if(isSuccess) {
					resp.sendRedirect(req.getContextPath() + "/user/web/VerifyCode");
				} else {
	...
	private void getLogin(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(session != null && session.getAttribute("account") != null) {
			resp.sendRedirect(req.getContextPath()+"/user/web/waiting");
			return;
		}
	...
	private void getWaiting(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(session != null && session.getAttribute("account") != null) {
			...
			resp.sendRedirect(req.getContextPath()+"/user/web/login");
		}
