...
@WebServlet(urlPatterns = { "/user/checkout", "/user/thanks", "/user/addbill", "/user/paymentMethodCart", "/user/vnpayajax" })
public class CheckoutController extends HttpServlet {
	...
	private void getPaymentMethodCart(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
